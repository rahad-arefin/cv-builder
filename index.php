	...
	<div id="form_container">
		<form id="resumeform" class="resume" action="build.php" method="post">
			<div id="formdescription">
				<h1><br>Dynamic CV builder<br>by Rahad Arefin<br><br></h1>
			...
			<div class="center">
				...
				<h3>Contact Details</h3>
					<label>Mobile No *:</label>
						...
						<p>Enter your 10 digit mobile number(excluding +880)</p>
					<br>
					<label>Email ID*:</label>
					<span>
						<input type="email" name="email" placeholder="e.g.mail@gmail.com" size="50" maxlength="150" value=""/><br>
				...
				<h3>Personal Details</h3>
					...
					<label>Religion</label>
						<input type="text" name="religion" size="30" maxlength="50" value=""/><br>
						<p>Enter Your Religion</p><br>
					</div>
					<label>Gender</label>
					<div class="gender">
			...
			<div class="footer">
			Designed & Developed by <a href="https://www.linkedin.com/in/rahad-arefin" target="_blank">Rahad Arefin</a>
			</div>
		</form>
	</div>
